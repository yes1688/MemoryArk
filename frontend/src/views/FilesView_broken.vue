          ...
          <div v-else-if="viewMode === 'grid'" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            <div 
              ...
              :class="['p-3 rounded-lg border-2 transition-all duration-200 cursor-pointer', 
                       selectedFileIds.includes(file.id) ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300 hover:shadow-md']"
            >
...
const selectedFileIds = computed(() => filesStore.selectedFiles.map(f => f.id))
