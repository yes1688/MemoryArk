  ...
  <div class="home-view bg-gray-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div class="dashboard-grid grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <!-- 我的收藏小工具 -->
        <div class="lg:col-span-1">
          <div class="widget bg-white rounded-win11 shadow-win11 border border-gray-200">
            ...
            <div class="widget-content p-4">
              <div class="text-center py-8">
                ...
                <h4 class="text-lg font-medium text-gray-900 mb-2">尚無收藏檔案</h4>
                <p class="text-gray-600 text-sm">點擊檔案上的星星圖示來收藏檔案</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="widget-content p-4">
              <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                >
                  ...
                  <span class="folder-name text-sm font-medium text-gray-900">共享資料夾</span>
                  <span class="file-count text-xs text-gray-500 block">245 個檔案</span>
                </router-link>
                ...
                >
                  ...
                  <span class="folder-name text-sm font-medium text-gray-900">安息日資料</span>
                  <span class="file-count text-xs text-gray-500 block">128 個檔案</span>
                </router-link>
                ...
                >
                  ...
                  <span class="folder-name text-sm font-medium text-gray-900">所有檔案</span>
                  <span class="file-count text-xs text-gray-500 block">{{ fileStore.files.length }} 個檔案</span>
                </router-link>
                ...
                >
                  ...
                  <span class="folder-name text-sm font-medium text-gray-900">訪問記錄</span>
                  <span class="file-count text-xs text-gray-500 block">查看歷史</span>
                </button>
              </div>
            </div>
          </div>
